CREATE DATABASE  IF NOT EXISTS `fishmanblogs_useraction` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `fishmanblogs_useraction`;
-- MySQL dump 10.13  Distrib 5.6.24, for osx10.8 (x86_64)
--
-- Host: localhost    Database: fishmanblogs_useraction
-- ------------------------------------------------------
